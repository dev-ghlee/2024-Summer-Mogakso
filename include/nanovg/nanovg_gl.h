...
static int glnvg__renderCreate(void* uptr)
{
	...
	static const char* fillFragShader =
		...
		"#endif\n"
		"		if (texType == 0) color = vec4(color.xyz/max(0.0000001,color.w),color.w);"
		"		if (texType == 1) color = vec4(color.xyz,color.w);"
		"		if (texType == 2) color = vec4(1,1,1,color.x);"
		...
		"	result.a = tonemap(invTonemap(result.a,outGamma.r),2.4);\n"
		// End Joony
		"#ifdef NANOVG_GL3\n"
		"	outColor = result;\n"
		"#else\n"
