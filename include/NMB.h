...
inline Result showNoRes( const char* p_title, const char* p_message, Icon icon )
{
#if defined(_WIN32)
	...
	int result = MessageBoxA( nullptr, p_message, p_title, MB_SYSTEMMODAL | icon_flag );
	...
	CFUserNotificationDisplayAlert( 0, cf_alert_icon, nullptr, nullptr, nullptr, cf_title, cf_message, CFSTR("OK"), nullptr, nullptr, &result );
